...
const Contact = () => {
  ...
  const handleSubmit = (e) => {
    ...
    // ADD THESE DEBUG LOGS HERE - RIGHT AT THE START OF handleSubmit
    ...
    emailjs
      .send(
        ...
        {
          from_name: form.name,
          to_name: "Anshu dhawan",
          from_email: form.email,
          to_email: "anshudhawan920@gmail.com",
      ...
      .then(
        (response) => {
          setLoading(false);
          console.log("Email sent successfully:", response); // Added this too
        ...
        (error) => {
          setLoading(false);
          console.error("EmailJS Error:", error); // Enhanced error logging
  ...
  return (
    ...
    >
      ...
      <motion.div
        variants={slideIn("right", "tween", 0.4, 1.5)}
        className='xl:flex-1 xl:h-auto md:h-[550px] h-[350px] flex justify-end items-center pl-16'
      >
        <EarthCanvas />
      </motion.div>
    </div>
